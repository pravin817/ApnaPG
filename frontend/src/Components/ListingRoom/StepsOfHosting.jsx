...
const StepsOfHosting = () => {
  return (
    <section className=" h-[90vh] grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10 justify-between items-center bg-white max-w-screen-xl xl:mx-auto mb-10 lg:mt-4">
      <h1 className=" text-[#222222] text-3xl sm:text-5xl xl:text-[56px] font-medium leading-tight">
        It’s easy to get started on ApnaPG
      </h1>
